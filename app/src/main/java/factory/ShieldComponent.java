...
public class ShieldComponent extends Component {
  ...
  /**
   * As the component is rectangular it takes current rotation into account using a basic approximation:
   * For example if the rectangle is rotated the bounding box is still axis aligned
   * +----------+ 
   * |    /\    | 
   * |   /  \   |
   * |  /    \  |
